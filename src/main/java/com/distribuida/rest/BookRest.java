...
public class BookRest {
    ...
    @GET
    @Path("/{id}")
    @Operation(summary = "Obtiene Libro por su id")
    ...
    @GET
    @Operation(summary = "Obtiene Libros de la base de datos")
    @APIResponse(description = "OK",
    ...
    @POST
    @Operation(summary = "Crea Libro", description = "Creacion de un Libro")
    public void insert(@RequestBody(description = "Libro a crear", required = true,
    ...
    @PUT
    @Path("/{id}")
    @Operation(summary = "Actualiza Libro", description = "Actualizacion de un Libro por id")
    public void update(@RequestBody(description = "Libro a actualizar", required = true,
                                    content = @Content(schema = @Schema(implementation = Book.class))) Book book,
                       @Parameter(description = "Id del Libro que se va a actualizar", required = true) @PathParam("id") Integer id) {
        book.setId(id);
    ...
    @DELETE
    @Path("/{id}")
    @Operation(summary = "Elimina Libro", description = "Elimina un Libro por id")
    public void delete(@Parameter(description = "Id del Libro que se va a eliminar", required = true) @PathParam("id") Integer id ) {
